...
class LosAngeles extends Component {
    constructor(){
        ...
        componentDidMount(){
            axios.get('https://vschool-cors.herokuapp.com?url=https://api.darksky.net/forecast/428c55ff888ba644ac222f62d49c46fc/34.052235,-118.243683,255657600?exclude=currently,flags').then(response => {
                this.setState({
