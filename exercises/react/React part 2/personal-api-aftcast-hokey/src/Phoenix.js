...
class Phoenix extends Component {
    constructor(){
        ...
        componentDidMount(){
            axios.get('https://vschool-cors.herokuapp.com?url=https://api.darksky.net/forecast/428c55ff888ba644ac222f62d49c46fc/33.448376,-112.074036,255657600?exclude=currently,flags').then(response => {
                this.setState({
